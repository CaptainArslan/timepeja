...
class DriverFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'licence_no' => $this->faker->regexify('/^0{5}[1-9][0-9]{4}-[A-Z]{3}$/'),
            'licence_no_front_pic' => $this->faker->imageUrl($width = 640, $height = 480, 'number plates'),
            'licence_no_back_pic' => $this->faker->imageUrl($width = 640, $height = 480, 'number plates'),
            'licence_expiry_date' => Carbon::now(),
            'otp' => rand(1000, 9999),
            'token' => Str::random(10),
            'status' => 1,
            'online_status' => 1,
