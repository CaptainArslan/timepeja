...
class CreateUsersDriversGaurdiansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('users_drivers_gaurdians', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('users_drivers_gaurdians');
    }
}
