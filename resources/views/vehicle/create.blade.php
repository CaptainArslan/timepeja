                ...
                <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                    <thead>
                        <tr>
                            ...
                            <th>front Picture</th>
                            <th>license plate picture</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($vehivles as $vehicle)
                        <tr>
                            <td>{{date("Y-m-d",strtotime($vehicle->created_at))}}</td>
                            <td>{{ date("H:m:s",strtotime($vehicle->created_at)) }}</td>
                            <td><b><a href="#">{{ $vehicle->organizations['name'] }}</a></b></td>
                            <td>{{ isset($vehicle->vehicles_types['name']) ? $vehicle->vehicles_types['name'] : 'Bus' }}</td>
                            <td>{{ $vehicle->number }}</td>
                            <td><img src="{{$vehicle->front_pic}}" height="50" width="50" alt=""></td>
                            <td><img src="{{$vehicle->back_pic}}" height="50" width="50" alt=""></td>
                            <td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="simpleinput" name="veh_no" placeholder="GAO174268" class="form-control">
                                        </div>
                                        <div class="col-12">
                                            <div class="mt-1">
