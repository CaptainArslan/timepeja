        ...
        <div class="col-12">
            <div class="page-title-box d-flex justify-content-between">
                ...
                <div class="page-title">
                    <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#createModal"> Add
                        Organization </button>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                                ...
                                <select class="form-control select2Filter" id="organization_filter" name="o_id">
                                    ...
                                    @forelse ($org_dropdowns as $organization)
                                        <option value="{{ $organization->id }}"
                                            {{ $organization->id == request()->input('o_id') ? 'selected' : '' }}>
                                            {{ $organization->branch_code }} - {{ $organization->name }} -
                                            {{ $organization->branch_name }}</option>
                                    @empty
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="date" class="form-control" name="from"
                                    value="{{ request()->input('from', old('from')) }}">
                            </div>
                            <div class="col-md-3">
                                <label for="to">Registration To</label>
                                <input type="date" class="form-control" name="to"
                                    value="{{ request()->input('to', old('to')) }}">
                            </div>
                            <div class="col-md-1">
                                <!-- <label for="route_list"></label> -->
                                <button type="submit" class="btn btn-success" id="route_list" value="filter" name="filter"
                        ...
                        <tbody>
                            @forelse ($organizations as $organization)
                                <tr>
                                    ...
                                    <td> {{ isset($organization->branch_code) ? $organization->branch_code . ' - ' : '' }}
                                        {{ $organization->branch_name }} </td>
                                    ...
                                    <td> <img src="{{ $organization->manager['picture'] }}" alt=""
                                    ...
                                    <td>
                                        <input type="hidden" name="" id=""
                                            value="{{ formatDate($organization->create_at) }}" class="db_date">
                                        <input type="hidden" name="" id=""
                                            value="{{ formatTime($organization->create_at) }}" class="db_time">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->manager['otp'] }}" class="db_otp">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->name }}" class="db_org_name">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->id }}" class="db_org_id">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->branch_name }}" class="db_branch_name">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->branch_code }}" class="db_branch_code">
                                        <input type="hidden" name="" id=""
                                            value="{{ isset($organization->organizationType['id']) ? $organization->organizationType['id'] . ' - ' : '' }}"
                                            class="db_org_type">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->email }}" class="db_org_email">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->phone }}" class="db_org_phone">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->manager['name'] }}" class="db_man_name">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->manager['email'] }}" class="db_man_email">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->manager['phone'] }}" class="db_man_phone">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->manager['picture'] }}" class="db_man_picture">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->head_name }}" class="db_head_name">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->head_email }}" class="db_head_email">
                                        <input type="hidden" name="" id=""
                                            value="{{ $organization->head_phone }}" class="db_head_phone">
                                        ...
                                        <div class="btn-group btn-group-sm delete_organization" style="float: none;"
                                            data-id="{{ $organization->id }}" onclick="deleteOrganization(this)">
                ...
                <div class="modal-body">
                    <div class="col-xl-12">
                        <div class="card shadow-none">
                            <div class="card-body">
                                <form action="{{ route('manager.store') }}" method="POST" id="organization_creation"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div id="basicwizard">
                                        <ul class="nav nav-pills bg-light nav-justified form-wizard-header mb-4">
                                            <li class="nav-item">
                                                <a href="#company" data-bs-toggle="tab" id="company_tab"
                                            ...
                                            <li class="nav-item">
                                                <a href="#company_head" data-bs-toggle="tab" id="company_head_tab"
                                                    data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2"
                                            ...
                                            <li class="nav-item">
                                                <a href="#transport_manager" data-bs-toggle="tab" data-toggle="tab"
                                                    id="transport_manager_tab" class="nav-link rounded-0 pt-2 pb-2"
                                            ...
                                            <li class="nav-item">
                                                <a href="#financials" id="financials_tabs" value="financials"
                                        ...
                                        <div class="tab-content b-0 mb-0 pt-0">
                                            ...
                                            <div class="tab-pane" id="company">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="org_name" class="form-label">Organization
                                                                Name</label>
                                                            <input type="text" id="org_name" name="org_name"
                                                                value="{{ old('org_name') }}" class="form-control"
                                                                placeholder="Punjab University" required>
                                                            <span class="text-danger" id="org_name_error"></span>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="org_branch_code" class="form-label">Branch
                                                                code</label>
                                                            <input type="text" id="org_branch_code"
                                                                name="org_branch_code"
                                                                value="{{ old('org_branch_code') }}" class="form-control"
                                                                placeholder="12345">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" id="org_email" name="org_email"
                                                                class="form-control" value="{{ old('org_email') }}"
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="mb-3">
                                                            <label for="org_branch_name" class="form-label">Branch
                                                                Name</label>
                                                            <input type="text" id="org_branch_name"
                                                                name="org_branch_name" class="form-control"
                                                                value="{{ old('org_branch_name') }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select select2" id="org_type"
                                                                name="org_type" required>
                                                                <option value="" selected>Please Select Organization
                                                                    Type
                                                                </option>
                                                                @forelse ($organization_types as $organizaton_type)
                                                                    <option value="{{ $organizaton_type->id }}">
                                                                        {{ $organizaton_type->name }}
                                                                        ({{ $organizaton_type->desc }})
                                                                    </option>
                                                                @empty
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="org_phone" name="org_phone"
                                                                class="form-control" value="{{ old('org_phone') }}"
                                                    ...
                                                    <div class="col-lg-12 row">
                                                        <div class="mb-3 col-4">
                                                            ...
                                                            <select class="form-select select2" id="org_state"
                                                                name="org_state" required>
                                                                <option value="" selected>Please Select State
                                                                </option>
                                                        ...
                                                        <div class="mb-3 col-4">
                                                            ...
                                                            <select class="form-select select2" id="org_city"
                                                                name="org_city">
                                                        ...
                                                        <div class="mb-3 col-4">
                                                            ...
                                                            <input class="form-control" id="org_address"
                                                                name="org_address" value="{{ old('org_address') }}">
                                                ...
                                                <div class="tab-pane" id="company_head">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="org_head_name" class="form-label">Head
                                                                    Name</label>
                                                                <input type="text" id="org_head_name"
                                                                    name="org_head_name" placeholder="John Doe"
                                                                    value="{{ old('org_head_name') }}"
                                                                    class="form-control" required>
                                                                <span class="text-danger" id="org_head_name_error"></span>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="org_head_phone" class="form-label">Phone
                                                                    No</label>
                                                                <input type="text" id="org_head_phone"
                                                                    name="org_head_phone"
                                                                    value="{{ old('org_head_phone') }}"
                                                                    placeholder="0300-1234567" class="form-control"
                                                                    required>
                                                                <span class="text-danger"
                                                                    id="org_head_phone_error"></span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="org_head_email"
                                                                    class="form-label">Email</label>
                                                                <input type="email" id="org_head_email"
                                                                    name="org_head_email" placeholder="test@gmail.com"
                                                                    value="{{ old('org_head_email') }}"
                                                                    class="form-control" placeholder="Email" required>
                                                                <span class="text-danger"
                                                                    id="org_head_email_error"></span>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="org_head_address"
                                                                    class="form-label">Address</label>
                                                                <input class="form-control" id="org_head_address"
                                                                    name="org_head_address"
                                                                    value="{{ old('org_head_address') }}"
                                                                    rows="5"></input>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <div class="mb-3">
                                                                    <label for="phone" class="form-label">Phone
                                                                        No</label>
                                                                    <input type="text" id="man_phone" name="man_phone"
                                                                        value="{{ old('phone') }}"
                                                                        placeholder="0300-1234567" class="form-control"
                                                                        required>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="mb-3">
                                                                    <label for="man_email"
                                                                        class="form-label">Email</label>
                                                                    <input type="email" id="man_email" name="man_email"
                                                                        value="{{ old('man_email') }}"
                                                                        aria-placeholder="text@gmail.com"
                                                                        class="form-control" placeholder="Email" required>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <label for="man_pic" class="form-label">Manager
                                                                        Picture</label>
                                                                    <input type="file" id="man_pic" name="man_pic"
                                                                        value="{{ old('man_pic') }}"
                                                                        class="form-control">
                                                                </div>
                                                                <!-- <div class="mb-3">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-3">
                                                                    <label for="man_address"
                                                                        class="form-label">Address</label>
                                                                    <textarea class="form-control" name="man_address" id="man_address" value="{{ old('man_address') }}" cols="30"
                                                                        rows="2" placeholder="123 Street lahore, Pakistan"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- </div> -->
                                                        ...
                                                        <div class="tab-pane" id="financials">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mt-2">
                                                                    <h4 class="header-title">Who we will charge the fee
                                                                        from:</h4>
                                                                    <div class="form-check mb-2 form-check-primary">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            name="wallet[]" id="org_wallet"
                                                                            value="org_wallet" required>
                                                                        <label class="form-check-label"
                                                                            for="org_wallet">Organization</label>
                                                                    </div>
                                                                    <div class="form-check mb-2 form-check-primary">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            name="wallet[]" id="driver_wallet"
                                                                            value="driver_wallet"
                                                                            onclick="driverWallet(this)">
                                                                        <label class="form-check-label"
                                                                            for="driver_wallet">Sub
                                                                            Contracting Driver</label>
                                                                    </div>
                                                                    <div class="form-check mb-2 form-check-primary">
                                                                        <input class="form-check-input" type="checkbox"
                                                                            name="wallet[]" id="passenger_wallet"
                                                                            value="passenger_wallet"
                                                                            onclick="passengerWallet(this)">
                                                                        <label class="form-check-label"
                                                                            for="passenger_wallet">Passengers</label>
                                                                    </div>
                                                                </div>

                                                                <!-- Amount of all users -->
                                                                <div class="col-md-12 mt-3 mb-2">
                                                                    <h4 class="header-title">Basis of payment calculation:
                                                                    </h4>
                                                                    <div class="row">
                                                                        <div class="col-3 d-flex align-items-center">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="payment[]"
                                                                                id="org_payment" value="org_payment"
                                                                                onchange="orgPaymentCheck()">
                                                                            <label class="form-check-label mx-1"
                                                                                for="org_payment">Organization</label>
                                                                        </div>
                                                                        <div class="col-2">
                                                                            <label for="org_amount"
                                                                                class="form-label">Amount</label>
                                                                            <input class="form-control" type="number"
                                                                                placeholder="Amount" name="org_amount"
                                                                                id="org_amount"
                                                                                value="{{ old('org_amount') }}">
                                                                        </div>
                                                                        <div class="col-1">
                                                                            <label for="org_trial_days"
                                                                                class="form-label">
                                                                                Days</label>
                                                                            <input class="form-control " type="number"
                                                                                name="org_trial_days" id="org_trial_days"
                                                                                value="{{ old('org_trial_days') }}"
                                                                                onchange="setNextDate('#org_trial_days', '#org_trail_start_date', '#org_trail_end_date')">
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <label for="org_trail_start_date"
                                                                                class="form-label">Starting
                                                                                Date</label>
                                                                            <input type="date"
                                                                                class="form-control today-date"
                                                                                id="org_trail_start_date"
                                                                                name="org_trail_start_date"
                                                                                value="{{ old('org_trail_start_date') }}"
                                                                                name="date"
                                                                                onchange="setDays('#org_trail_start_date','#org_trail_end_date','#org_trial_days'); setNextDate('#org_trial_days', '#org_trail_start_date', '#org_trail_end_date')">
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <label for="org_trail_end_date"
                                                                                class="form-label">Ending
                                                                                Date</label>
                                                                            <input type="date" class="form-control"
                                                                                id="org_trail_end_date"
                                                                                name="org_trail_end_date"
                                                                                value="{{ old('org_trail_end_date') }}"
                                                                                name="date"
                                                                                onchange="setDays('#org_trail_start_date','#org_trail_end_date','#org_trial_days')">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mt-2">
                                                                        <div class="col-3 d-flex align-items-center">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="payment[]"
                                                                                id="driver_payment" value="driver_payment"
                                                                                onchange="driverPaymentCheck()">
                                                                            <label class="form-check-label mx-1"
                                                                                for="driver_payment">Driver</label>
                                                                        </div>
                                                                        <div class="col-2 ">
                                                                            <input class="form-control" type="number"
                                                                                placeholder="Amount" name="driver_amount"
                                                                                value="{{ old('driver_amount') }}"
                                                                                id="driver_amount">
                                                                        </div>
                                                                        <div class="col-1 ">
                                                                            <input class="form-control " type="number"
                                                                                name="driver_trial_days"
                                                                                id="driver_trial_days"
                                                                                value="{{ old('driver_trial_days') }}"
                                                                                onchange="setNextDate('#driver_trial_days', '#driver_trial_start_date', '#driver_trial_end_date')">
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="date"
                                                                                class="form-control today-date"
                                                                                id="driver_trial_start_date"
                                                                                name="driver_trial_start_date"
                                                                                value="{{ old('driver_trial_start_date') }}"
                                                                                name="date"
                                                                                onchange="setDays('#driver_trial_start_date','#driver_trial_end_date','#driver_trial_days'); setNextDate('#driver_trial_days', '#driver_trial_start_date', '#driver_trial_end_date')">
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="date" class="form-control"
                                                                                id="driver_trial_end_date"
                                                                                name="driver_trial_end_date"
                                                                                value="{{ old('driver_trial_end_date') }}"
                                                                                name="date"
                                                                                onchange="setDays('#driver_trial_start_date','#driver_trial_end_date','#driver_trial_days')">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mt-2">
                                                                        <div class="col-3 d-flex align-items-center">
                                                                            <input class="form-check-input"
                                                                                type="checkbox" name="payment[]"
                                                                                id="passenger_payment"
                                                                                value="passenger_payment"
                                                                                onchange="passengerPaymentCheck()">
                                                                            <label class="form-check-label mx-1"
                                                                                for="passenger_payment">Passenger</label>
                                                                        </div>
                                                                        <div class="col-2 ">
                                                                            <input class="form-control" type="number"
                                                                                placeholder="Amount"
                                                                                ...
                                                                                id="passenger_amount"
                                                                                value="{{ old('passenger_amount') }}">
                                                                        </div>
                                                                        <div class="col-1 ">
                                                                            <input class="form-control" type="number"
                                                                                name="passenger_trial_days"
                                                                                id="passenger_trial_days"
                                                                                value="{{ old('passenger_trial_days') }}"
                                                                                onchange="setNextDate('#passenger_trial_days', '#passenger_trail_start_date', '#passenger_trail_end_date')">
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="date"
                                                                                class="form-control today-date"
                                                                                id="passenger_trail_start_date"
                                                                                name="passenger_trail_start_date"
                                                                                value="{{ old('passenger_trail_start_date') }}"
                                                                                name="date">
                                                                        </div>
                                                                        <div class="col-3">
                                                                            <input type="date" class="form-control"
                                                                                id="passenger_trail_end_date"
                                                                                name="passenger_trail_end_date"
                                                                                value="{{ old('passenger_trail_end_date') }}"
                                                                                name="date"
                                                                                onchange="setDays('#driver_trial_start_date','#driver_trial_end_date','#driver_trial_days')">
                                                                        </div>
                                                                    </div>
