!(function (a) {
    ...
    (e.prototype.createBasic = function (e) {
        ...
        (e.prototype.createWithPolygon = function (e, t) {
            var l = new GMaps({ div: e, lat: -12.043333, lng: -77.028333 });
            l.drawPolygon({
                paths: t,
                strokeColor: "#BBD8E9",
                strokeOpacity: 1,
        ...
        (e.prototype.createWithRoutes = function (e, t, l) {
            var r = new GMaps({ div: e, lat: t, lng: l });
            return (
                a("#start_travel").click(function (e) {
                    e.preventDefault(),
                        r.travelRoute({
        ...
        (e.prototype.createWithMenu = function (e, t, l) {
            new GMaps({ div: e, lat: t, lng: l }).setContextMenu({
                control: "map",
                options: [
                    {
                        title: "Add marker",
